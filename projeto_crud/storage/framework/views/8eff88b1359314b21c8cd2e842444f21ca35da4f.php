...
<body>
    <div class="container_error">
        ...
        <p><?php echo e($exception->getMessage() . ' Jaguara' . $msg ?: 'Você não tem permissão para visualizar esta página.'); ?></p>
        <!-- Habilita um link para direcionar para a Index
        <p><a href="<?php echo e(url('/veiculos')); ?>">Voltar para a página inicial</a></p>
    </div>
</body>
</html><?php /**PATH C:\Users\06943040936\Documents\Ambiente_Teste\Projetos\projeto_crud\resources\views/errors/access-denied.blade.php ENDPATH**/ ?>